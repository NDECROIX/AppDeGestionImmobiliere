...
public class PhotoContentProvider extends ContentProvider {
    ...
    // FOR DATA
    public static final String AUTHORITY = "com.openclassrooms.nycrealestatemanager.PhotoContentProvider";
    ...
    public Cursor query(@NonNull Uri uri, @Nullable String[] projection, @Nullable String selection, @Nullable String[] selectionArgs, @Nullable String sortOrder) {
        if (getContext() != null) {
            final Cursor cursor = AppDatabase.getInstance(getContext()).photoDAO().getAllWithCursor();
